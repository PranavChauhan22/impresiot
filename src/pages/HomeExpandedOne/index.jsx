...
const HomeExpandedOnePage = () => {
  ...
  return (
    <>
      <div className="bg-black-900 flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-5 md:gap-5 items-start mx-auto pb-[22px] w-full">
...
export default HomeExpandedOnePage;
