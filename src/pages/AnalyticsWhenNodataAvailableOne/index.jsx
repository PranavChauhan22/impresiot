...
const AnalyticsWhenNodataAvailableOnePage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
            ...
            <div className="flex flex-col md:gap-10 gap-[60px] items-center justify-start mb-1 w-[99%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                <div className="flex md:flex-1 flex-col md:gap-10 gap-[60px] items-center justify-start w-[56%] md:w-full">
                  ...
                  <div className="md:h-[501px] h-[505px] sm:h-[817px] relative w-full">
                    <Text
                    ...
                    <div className="absolute flex flex-col gap-[29px] h-max inset-[0] justify-center m-auto w-full">
                      ...
                      <div className="font-inter md:h-[437px] h-[438px] sm:h-[753px] relative w-full">
                        <div className="absolute bottom-[7%] flex flex-col items-center justify-start right-[6%] w-4/5">
                          ...
                          <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-[99%] md:w-full">
                            ...
                            <List
                              className="sm:flex-col flex-row gap-3 grid grid-cols-2 w-[5%] sm:w-full"
                              orientation="horizontal"
                            >
...
export default AnalyticsWhenNodataAvailableOnePage;
