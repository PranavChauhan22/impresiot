          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col items-center justify-start p-[35px] sm:px-5 w-[99%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-[17px] w-[99%] md:w-full">
                ...
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[18px] w-full">
                  <Img
                    className="h-[172px] md:h-auto object-cover rounded-[10px]"
                    src="images/img_rectangle5_172x306.png"
                    alt="rectangleFive"
                  />
                  <Img
                    className="h-[172px] md:h-auto object-cover rounded-[10px]"
                    src="images/img_rectangle6_172x306.png"
                    alt="rectangleSix"
                  />
                  <Img
                    className="h-[172px] md:h-auto object-cover rounded-[10px]"
                    src="images/img_rectangle7_172x306.png"
                    alt="rectangleSeven"
                  />
                  <Img
                    className="h-[172px] md:h-auto object-cover rounded-[10px]"
...
export default UploadCoursePageTwoPage;
