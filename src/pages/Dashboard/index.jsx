...
const DashboardPage = () => {
  ...
  return (
    <>
      <div className="bg-black-900 flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-10 md:gap-10 items-start justify-between mx-auto sm:pl-5 pl-8 w-full">
        <Sidebar className="!sticky !w-[284px] flex h-screen md:hidden justify-start md:mt-0 mt-[35px] overflow-auto md:px-5 top-[0]">
          ...
          <Button
            className="common-pointer bg-transparent cursor-pointer flex items-center justify-center min-w-[134px] md:ml-[0] ml-[26px] mr-[123px] mt-64"
          ...
          <Menu
            ...
            className="flex flex-col items-center justify-start pr-3.5 w-[95%]"
          >
            <SubMenu
              icon={
                <Img
            ...
            >
              <div className="flex flex-col items-center justify-end mt-6 w-full">
                ...
                >
                  <div className="flex flex-col items-start justify-end md:pl-10 sm:pl-5 pl-[49px] pr-px py-px">
                    <Text>Analytics</Text>
                  </div>
                </MenuItem>
              </div>
          ...
          <Button
            className="cursor-pointer font-semibold leading-[normal] min-w-[181px] ml-6 md:ml-[0] mr-[79px] mt-[379px] rounded-[5px] text-center text-xl"
            color="red_500"
            size="xl"
            variant="fill"
          >
