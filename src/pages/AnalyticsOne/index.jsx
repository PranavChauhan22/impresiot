...
const AnalyticsOnePage = () => {
  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      ...
      table1ColumnHelper.accessor("viewcount", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("revenue", {
        cell: (info) => (
          <Text
  ...
  return (
    <>
      <div className="bg-black-900 flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-10 md:gap-10 items-start justify-between mx-auto pb-[18px] pl-[18px] w-full">
        <Sidebar
          onClick={() => collapseSidebar(!collapsed)}
          className="!sticky !w-[285px] flex h-screen md:hidden justify-start md:ml-[0] ml-[13px] md:mt-0 mt-[35px] overflow-auto md:px-5 top-[0]"
        >
          ...
          <Button
            className="common-pointer bg-transparent cursor-pointer flex items-center justify-center min-w-[161px] md:ml-[0] ml-[29px] mr-[94px] mt-[77px]"
          ...
          <Button
            className="common-pointer bg-transparent cursor-pointer flex items-center justify-center min-w-[134px] md:ml-[0] ml-[27px] mr-[123px] mt-[148px]"
          ...
          <Menu
            ...
            className="flex flex-col items-center justify-start pr-[15px] w-[95%]"
          >
            <MenuItem
              icon={
                <Img
          ...
          {!collapsed && (
            <Button
              className="cursor-pointer font-semibold leading-[normal] min-w-[181px] md:ml-[0] ml-[25px] mr-[79px] mt-[379px] rounded-[5px] text-center text-xl"
              color="red_500"
              size="xl"
              variant="fill"
            >
...
export default AnalyticsOnePage;
