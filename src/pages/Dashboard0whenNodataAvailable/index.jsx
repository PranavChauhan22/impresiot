...
const Dashboard0whenNodataAvailablePage = () => {
  const sideBarMenu = [
    {
      label: (
  ...
  return (
    <>
      <div className="bg-black-900 flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-5 md:gap-5 items-start mx-auto w-full">
        ...
        <div className="flex-1 sm:h-[1098px] h-[1236px] md:h-[1993px] md:px-5 relative w-full">
...
export default Dashboard0whenNodataAvailablePage;
